...
if galaxy == 'smc':
	...
	models = {
		...
		"shs_ab":	 pd.read_csv(data_dir+'1_Models/Stripped_Stars/stripped_stars_Z0.002_ABmag.txt',sep=r'\s+',comment='#')		
	}
...
if galaxy == 'lmc':
	...
	models = {
		...
		"shs_ab":	 pd.read_csv(data_dir+'1_Models/Stripped_Stars/stripped_stars_Z0.006_ABmag.txt',sep=r'\s+',comment='#')
	}
